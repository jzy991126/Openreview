...
data_2017 = pd.read_excel(os.path.abspath('../../../data/Data analysis/data/tp_2017conference.xlsx'),
                          sheet_name='tp_2017conference')
data_2018 = pd.read_excel(os.path.abspath('../../../data/Data analysis/data/tp_2018conference.xlsx'),
                          sheet_name='tp_2018conference')
data_2019 = pd.read_excel(os.path.abspath('../../../data/Data analysis/data/tp_2019conference.xlsx'),
                          sheet_name='tp_2019conference')
